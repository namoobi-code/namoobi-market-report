...
| 3.1.7A | **메모리+HBM(그래프 6종·HBM 3사 EPS/PER·대시보드)** | **[DB화]+누적 업그레이드** | 분기 컨센서스/실적 | `nmr_hbm.json` (기존 승계) |
| 3.1.7B | **반도체 사이클→코스피 점검판(핵심 한 줄·조기경보 3신호표: 재고주수·계약가 QoQ·CAPEX YoY)** | **[DB화]** | 3대 신호/코스피 쏠림 변동(asof) | `db/semi_cycle.json` |

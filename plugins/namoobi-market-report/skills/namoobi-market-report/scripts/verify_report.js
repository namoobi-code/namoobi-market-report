...
// (v3.51) [AppC] AI value-chain stocks -- data present => count + spark coverage; absent => warning (section omitted). (v3.52.1) 43->46 (ORCL/007660/AMKR) (v4.03) 46->50 (MLCC 후발 3인방·유리기판·BE)
try{
  ...
  else { if(n<50) warnings.push('[AppC] AI value-chain rows '+n+'<50 (v4.03: check fetch_appc.py)');

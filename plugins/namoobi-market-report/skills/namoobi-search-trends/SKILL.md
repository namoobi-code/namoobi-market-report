...
```json
{
  ...
  "kr":     {"title": "🇰🇷 인스타 주간 트렌드 (한국)",   "items": [["제목","한줄 해설","링크URL"], ...6개]},
  "global": {"title": "🌎 인스타 주간 트렌드 (글로벌)",   "items": [[..., ..., ...], ...6개]},
  "google_wk":  {"title": "🔍 구글 주간 해설",
    "kr": {"head": "이번 주 한 줄 총평", "items": [["키워드(검색량)","왜 떴나 해설"], ...4개]},
    "us": {"head": "...", "items": [...4개]}},
  "youtube_wk": {"title": "▶️ 유튜브 주간 해설", "kr": {...}, "us": {...}},
  "naver_long": {"title": "🛒 네이버 쇼핑 장기 해석 (5년 클릭 추이)", "head": "...", "items": [...4개]},
...
2. 인스타 글로벌: `Instagram trends this week <month year> reels trending audio formats`
   (Lightreel·Newengen·HeyOrca·SocialPilot 주간 리포트가 정기 소스)
3. 구글 주간 배경: 서버 랭킹 상위 키워드 중 맥락 불명인 것만 뉴스 검색으로 배경 확인

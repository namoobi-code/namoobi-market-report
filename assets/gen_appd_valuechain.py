...
SECTIONS = [
 ...
 ("5. 후공정 — 패키징 · 테스트 · 기판", "HBM 적층과 서버 조립의 관문 · AI 서버용 FC-BGA 92억$(2025)→185억$(2032) [360iResearch]", [
  ("042700","한미반도체","선두",B1,"HBM TC본더 선두 — SK하이닉스와 동반 성장"),
  ("4062.T","이비덴 (Ibiden)","FC-BGA 70~80%",B1,"AI 서버용 패키지기판 과점 — 칩 설계 단계부터 공동개발, 2028년까지 5000억엔 증설"),
  ("009150","삼성전기","MLCC 양강",B2,"FC-BGA 추격 + AI 서버용 MLCC 가동률 91%·유통가 30% 인상 — 모건스탠리 국내 최선호 교체"),
  ("6981.T","무라타 (Murata)","MLCC 양강",B2,"AI 서버용 MLCC 삼성전기와 양분 — 서버 1대 2천개 → VR200 NVL72 57만개로 탑재량 폭증"),
  ("삼화콘덴서·아바텍·아모텍","",None,None,"범용 MLCC 품귀의 후발 3인방 — 공급자 우위 전이 수혜 후보(소형·변동성 큼)"),
 ...
 ("6. 전력 · 인프라 — 데이터센터를 돌리는 힘", "칩보다 전기가 부족한 시대", [
  ...
  ("BE","Bloom Energy",None,None,"SOFC 온사이트 발전 — 가스터빈 대기열(2031년 인도)의 우회로, 설치 55~90일"),
 ]),
]

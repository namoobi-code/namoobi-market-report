...
SECTIONS = [
 ("1. 완성체 — 휴머노이드 메이커 (부품 발주의 출발점)",
  ...
  ("TSLA","테슬라 옵티머스",None,None,"2026.2Q 프리몬트 모델S·X 라인을 옵티머스 전용라인으로 전환 — 연 100만대 설계"),
  ("005380","현대차그룹·BD","BD 100%",B2,"소프트뱅크 지분 전량 인수(7월) — 아틀라스 2028 조지아 공장 투입·구글 딥마인드 제미나이 협력"),
  ("피겨AI (Figure)","",None,B3,"오픈AI 협업 → 자체 모델 헬릭스 02로 전환, 물류 현장 200시간 실증"),
  ("애지봇 (AgiBot)","비상장","점유 1위",B2,"2025년 5168대 출하·점유 39%[옴디아] — 홍콩 IPO 절차 진행"),
  ("688836","유니트리 (Unitree)","8/19 상장",B2,"상하이 STAR 첫날 +460%·시총 530억$ — R1 2만9900위안(670만원) 가격 파괴"),
  ("9880.HK","UBTech",None,None,"워커 S1 — BYD 공장 운반·NIO 라인 조립 실증, 산업용 선두권"),
  ("002594","BYD",None,None,"휴머노이드 사업 진출 공식화 — 자동차 딜러망 활용 판매 검토"),
  ("XPEV","샤오펑 (XPeng)",None,None,"광저우 공장에서 '아이언(IRON)' 소량 테스트 생산"),
  ("277810","레인보우로보틱스","삼성 35%",B2,"삼성전자 최대주주·연결 자회사 — RB-Y1 쿠팡 물류센터 실증"),
  ("어질리티·앱트로닉·1X","",None,B3,"어질리티 SPAC 25억$ 추진(RoboFab 연 1만대)·앱트로닉 누적 9.4억$ — 손 자유도가 승부처"),
 ]),
 ("2. 두뇌 — 파운데이션 모델(VLA) · 온디바이스 AI 칩",
  ...
  ("리얼월드 (RLWRLD)","",None,B3,"국산 RFM 'RLDX-1' 글로벌 벤치마크 8종 SOTA — 손재주 벤치마크 덱스벤치를 엔비디아 Isaac Lab-Arena 연결"),
 ]),
 ...
 ("4. 근육·관절 — 액추에이터 · 감속기 · 모터 · 베어링 · 영구자석",
  ...
  ("066570","LG전자",None,None,"엔비디아 GR00T 기반 이족보행 휴머노이드 개발(내년 1Q 공개 목표) — DD모터 구동 노하우"),
